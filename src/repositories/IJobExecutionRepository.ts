...
export interface IJobExecutionRepository {
  ...
  markSuccess(executionId: string, finishedAt?: Date): Promise<JobExecution>;
  markFailed(executionId: string, errorSanitized: string, finishedAt?: Date): Promise<JobExecution>;
